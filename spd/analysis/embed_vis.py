...
class DataFrameMetadata:
    ...
    def describe(self) -> str:
        ...
        desc = f"Analysis DataFrame with {self.n_features} features ({self.n_alive_features} alive)\n\n"
...
def coactivation_analysis(
    ...
    """
    Comprehensive analysis of a coactivation group, returning a DataFrame with embeddings and clusterings.
    ...
    # Returns:
     - `pd.DataFrame`
        ...
        - `feat.class.{embed_method}.{embed_hparams}.{cluster_method}.{cluster_hparams}`: cluster labels
     - `DataFrameMetadata`
